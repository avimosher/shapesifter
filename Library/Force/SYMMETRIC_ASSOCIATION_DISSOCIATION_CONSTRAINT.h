#ifndef __SYMMETRIC_ASSOCIATION_DISSOCIATION_CONSTRAINT__
#define __SYMMETRIC_ASSOCIATION_DISSOCIATION_CONSTRAINT__
...
template<class TV>
class STORED_SYMMETRIC_ASSOCIATION_DISSOCIATION_CONSTRAINT:public FORCE_REFERENCE<typename TV::Scalar>
{
    typedef typename TV::Scalar T;
...
public:
    ...
    STORED_SYMMETRIC_ASSOCIATION_DISSOCIATION_CONSTRAINT(){}
    virtual ~STORED_SYMMETRIC_ASSOCIATION_DISSOCIATION_CONSTRAINT(){}

    void setZero(){value.setZero();}
    virtual int Size(){return constraints.size()*(d+t);}
    DEFINE_TYPE_NAME("STORED_SYMMETRIC_ASSOCIATION_DISSOCIATION_CONSTRAINT");
};


template<class TV>
class SYMMETRIC_ASSOCIATION_DISSOCIATION_CONSTRAINT : public FORCE_TYPE<TV>
{
    typedef typename TV::Scalar T;
